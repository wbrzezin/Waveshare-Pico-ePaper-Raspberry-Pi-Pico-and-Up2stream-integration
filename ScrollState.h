...
// Plik    : ScrollState.h                                  // File    : ScrollState.h                        //
//                                                          //                                               //
// Opis:                                                    // Description:                                  //
//                                                          //                                               //
...
// w jednym miejscu i nie zaśmiecają klasy Display.         // in one place without cluttering the Display    //
//                                                          // class.                                        //
//==============================================================//-----------------------------------------------//
...
//                                                          //                                               //
// Przechowuje aktualny stan animacji przewijanego tekstu.   // Stores the current state of the scrolling      //
//                                                          // text animation.                               //
//==============================================================//-----------------------------------------------//
...
struct ScrollState
{
    ...
    //----------------------------------------------------------//-----------------------------------------------//
    // Dostępna szerokość pola.                                 // Available field width.                       //
    //----------------------------------------------------------//-----------------------------------------------//
